...
call <sid>hi("MatchParen",    s:gui00, s:gui0C, s:cterm00, s:cterm03,  "")
...
call <sid>hi("rubyConditional",             s:gui0D, "", s:cterm0A, "", "")
...
call <sid>hi("jsTernaryIfOperator", s:gui08, "", s:cterm05, "", "none")
