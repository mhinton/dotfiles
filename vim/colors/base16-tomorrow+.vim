" My modifications to Base16 Tomorrow
...
call <sid>hi("Folded",        s:gui03, s:gui01, s:cterm03, s:cterm00, "")
call <sid>hi("IncSearch",     s:gui0A, "", s:cterm0B, "", "")
...
call <sid>hi("Search",        s:gui0A, s:gui01, s:cterm0D, "none",  "reverse")
...
call <sid>hi("LineNr",        s:gui03, s:gui01, s:cterm05, s:cterm00, "")
call <sid>hi("SignColumn",    s:gui03, s:gui01, s:cterm03, s:cterm00, "")
call <sid>hi("SpecialKey",    s:gui03, "", s:cterm03, "", "")
...
call <sid>hi("PMenu",         s:gui04, s:gui01, s:cterm04, s:cterm00, "none")
call <sid>hi("PMenuSel",      s:gui04, s:gui01, s:cterm03, s:cterm00, "reverse")
...
call <sid>hi("Identifier",   s:gui0C, "", s:cterm08, "", "none")
...
call <sid>hi("Statement",    s:gui08, "", s:cterm08, "", "none")
...
hi! link rubyControl rubyConditional
