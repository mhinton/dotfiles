...
let g:Powerline#Colorschemes#mhintonlight#colorscheme = Pl#Colorscheme#Init([
        ...
        \ Pl#Hi#Segments(['fileinfo.flags'], {
                ...
                \ }),
        \
        \ Pl#Hi#Segments(['currenttag', 'fullcurrenttag', 'scrollpercent', 'fileformat', 'fileencoding', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup'], {
                \ 'n': ['gray9', 'gray2'],
                \ 'N': ['gray9', 'gray5'],
                \ 'i': ['mediumcyan', 'darkestblue'],
                \ }),
